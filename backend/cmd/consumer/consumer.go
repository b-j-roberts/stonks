...
import (
	...
	"github.com/b-j-roberts/stonks/backend/routes/indexer"
)
...
func main() {
	...
	core.StonksBackend = core.NewBackend(databases, backendConfig, false)

	routes.InitBaseRoutes()
	indexer.InitIndexerRoutes()
	indexer.StartMessageProcessor()

	core.StonksBackend.Start(core.StonksBackend.BackendConfig.ConsumerPort)
}
